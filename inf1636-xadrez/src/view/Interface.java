...
public class Interface extends Canvas {
    ...
    public void setAPI(ViewAPI api) {
        this.api = api;
    }
    ...
    protected HashMap<String, BufferedImage> getImageMap() {
        return imageMap;
    }
    ...
    protected List<int[]> getMovimentosPossiveis() {
    ...
    public void paint(Graphics g) {
        ...
        for (int row = 0; row < BOARD_SIZE; row++) {
            for (int col = 0; col < BOARD_SIZE; col++) {
                ...
                if (api != null && api.isThereAPiece(currentRow, currentCol)) {
    ...
    private HashMap<String, BufferedImage> loadImages() {
        ...
        for (String cor : cores) {
            for (String tipo : nomes) {
                String arquivo = cor + tipo + ".png";
                String caminho = "/view/img/" + arquivo;
                try {
